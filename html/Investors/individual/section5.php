        ...
        <div class="flex justify-between items-start max-w-[822px] gap-x-[111px] mx-auto">
            ...
            <div class="max-w-[353px] flex flex-col  items-center tracking-widest">
                ...
                <p class="text-base">
                    ...
                    <span class="font-bold">2030年でDOE 5%を目標に、</span>
                    継続的に配当金の増額を実施してまいります。また、自己株式の取得も機動的に検討いたします。
                </p>
            </div>
            <!-- Right -->
            <div class="max-w-[353px] flex flex-col items-center tracking-widest">
                ...
                <p class="text-base">
                    ...
                    において、 1,000株（10単元）以上を保有の株主様に、優待商品を進呈させていただきます。
                </p>
            </div>

        </div>

       <div class="mt-[65px] flex justify-center items-center">
           <button class="flex justify-center items-center bg-blue-750 hover:scale-105 text-white
